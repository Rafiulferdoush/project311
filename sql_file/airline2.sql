...
INSERT INTO `airport` VALUES ('DAC','Hazrat Shahjalal International Airport','Shahjalal','Dhaka','Bangladesh'),('CTG','Shah Amanat International Airport','Shah Amanat','Chittagong','Bangladesh'),('DFW','Dallas Fort Worth Airport','Dallas','Texas','USA'),('LAX','Los Angeles International Airport','Los Angeles','California','USA'),('SEA','Seattle-Tacoma International Airport','Seattle','Washington','USA'),('SFO','San Francisco International','San Fransciso','California','USA');
